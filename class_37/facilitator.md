...
- Show this is not markup by changing className to class. Codesandbox will still render the last good page, but note the console-error.
...
- Discuss the tailwind syntax.  The syntax may be new but it directly relates to things you know in css
